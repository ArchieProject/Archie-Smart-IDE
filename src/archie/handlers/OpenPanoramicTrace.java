...
import archie.views.PanoramicTraceView;

/*******************************************************
 * A handler to open the panoramic trace view.
 *******************************************************/
public class OpenPanoramicTrace implements IHandler
{
	...
	public Object execute(ExecutionEvent event) throws ExecutionException
	{
		...
		// Opening views
		EclipsePlatformUtils.openView(PanoramicTraceView.VIEW_ID);
